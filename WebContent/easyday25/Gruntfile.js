...
module.exports = function (grunt) {
	...
	grunt.registerTask('default', ['clean:cleanBefore','ngtemplates','concat', 'removelogging', 'cssmin', 'copy','replace:replaceLocal','replace:debug', 'clean:cleanAfter']);
	grunt.registerTask('ci', 'Run the CI build', function () {
	       
        grunt.task.run(['clean:cleanBefore','ngtemplates','concat' , 'removelogging', 'cssmin', 'copy','replace:replaceLocal','replace:debug', 'clean:cleanAfter']);
    });
